...
function PopUp(){
  ...
  document.getElementById("block").style.overflow = "scroll"
}
...
const redes = [
    { icon: 'https://cdn-icons-png.flaticon.com/512/2111/2111463.png', alt: 'Instagram' },
    { icon: 'https://cdn-icons-png.flaticon.com/512/733/733547.png', alt: 'Facebook' },
    { icon: 'https://cdn-icons-png.flaticon.com/512/3670/3670151.png', alt: 'WhatsApp' },
    { icon: 'https://cdn-icons-png.flaticon.com/512/2991/2991148.png', alt: 'Google' }
];
redes.forEach(r => {
    const img = document.createElement('img');
    img.src = r.icon;
